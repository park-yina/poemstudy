...
function useCollapseInactiveCategoryOnNavigation({
  isActive,
  collapsed,
  setCollapsed,
  activePath,
  ...
  useEffect(() => {
    const navigatedToAnotherDoc =
      previousActivePath != null && activePath !== previousActivePath;

    if (
      navigatedToAnotherDoc &&
      collapsible &&
      !isActive &&
      !collapsed
    ) {
...
function DocSidebarItemCategoryCollapsible({
  ...
  useCollapseInactiveCategoryOnNavigation({
    isActive,
    collapsed,
    setCollapsed,
    activePath,
